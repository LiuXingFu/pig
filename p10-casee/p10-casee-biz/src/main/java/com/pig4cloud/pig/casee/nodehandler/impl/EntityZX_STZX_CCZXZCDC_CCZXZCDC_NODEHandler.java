...
public class EntityZX_STZX_CCZXZCDC_CCZXZCDC_NODEHandler extends TaskNodeHandler {
	...
	public void handlerTaskSubmit(TaskNode taskNode) {
		...
		expenseRecord.setSubjectName(entityZX_stzx_cczxzcdc_cczxzcdc.getSubjectName());
		...
		expenseRecordSubjectRe.setSubjectId(entityZX_stzx_cczxzcdc_cczxzcdc.getSubjectId());
		...
		paymentRecord.setSubjectName(entityZX_stzx_cczxzcdc_cczxzcdc.getSubjectName());
		paymentRecordService.save(paymentRecord);

		//添加抵偿回款信息关联债务人
		PaymentRecordSubjectRe paymentRecordSubjectRe=new PaymentRecordSubjectRe();
		paymentRecordSubjectRe.setSubjectId(entityZX_stzx_cczxzcdc_cczxzcdc.getSubjectId());
		...
		for (PaymentRecordAddDTO record : paymentRecordList) {
			...
			paymentRecordSubject.setSubjectId(entityZX_stzx_cczxzcdc_cczxzcdc.getSubjectId());
