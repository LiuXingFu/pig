...
import com.pig4cloud.pig.gateway.comm.PArithmeticCaptchaAbstract;
...
public class ImageCodeHandler implements HandlerFunction<ServerResponse> {
	...
	public Mono<ServerResponse> handle(ServerRequest serverRequest) {
		PArithmeticCaptchaAbstract captcha = new PArithmeticCaptchaAbstract(DEFAULT_IMAGE_WIDTH, DEFAULT_IMAGE_HEIGHT);
