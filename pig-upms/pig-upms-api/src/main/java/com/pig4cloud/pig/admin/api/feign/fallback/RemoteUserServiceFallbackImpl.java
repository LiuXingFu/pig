...
public class RemoteUserServiceFallbackImpl implements RemoteUserService {
	 ...
	 */
	@Override
	public R<UserVO> getUserById(Integer id, String from) {
	 ...
	 */
	@Override
	public R updateUserClientInfo(String username, String clientId, String from) {
		log.error("feign 更新用户设备信息:{}", username, cause);
		return null;
	}
