...
public class SysDictItemServiceImpl extends ServiceImpl<SysDictItemMapper, SysDictItem> implements SysDictItemService {
	 ...
	 */
	@Override
	public SysDictItem getDictBySysDictItem(SysDictItem sysDictItem) {
		return this.getOne(new LambdaQueryWrapper<SysDictItem>().eq(SysDictItem::getType, sysDictItem.getType())
				.eq(SysDictItem::getValue, sysDictItem.getValue()).eq(SysDictItem::getDelFlag, 0));
	}
